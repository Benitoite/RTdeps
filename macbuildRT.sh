...
cd ~/pango && meson wrap promote subprojects/glib/subprojects/proxy-libintl.wrap && mkdir build && cd build && meson --prefix=/opt/local --sysconfdir=/etc .. && ninja && sudo ninja install
