...
#  macbuildRT.sh
#  Builds RawTherapee on macOS 10.15.2 / Xcode 11.3.1
#
...
cd ~/autoconf* && CC=clang CXX=clang++ ./configure --prefix=/opt/local && make -j8 && sudo make install

cd ~/automake && CC=clang CXX=clang++ ./bootstrap --prefix=/opt/local && ./configure --prefix=/opt/local && make -j8 && sudo make install

cd ~/xz* && CC=clang CXX=clang++ ./configure --prefix=/opt/local && make -j8 && sudo make install
...
cd ~/tiff/tiff* && sudo rm -r build-aux || mkdir build-aux && cd build-aux && cmake .. -DCMAKE_OSX_SYSROOT:PATH=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -DCMAKE_OSX_DEPLOYMENT_TARGET:STRING=10.9 -DCMAKE_BUILD_TYPE:STRING=Release -DCMAKE_INSTALL_PREFIX:PATH=/opt/local && make -j8 && sudo make install

cd ~/zlib && rm -r build || mkdir build && cd build && cmake .. -DCMAKE_OSX_SYSROOT:PATH=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -DCMAKE_OSX_DEPLOYMENT_TARGET:STRING=10.9 -DCMAKE_BUILD_TYPE:STRING=Release -DCMAKE_INSTALL_PREFIX:PATH=/opt/local && make -j8 && sudo make install

cd ~/libpng && sudo rm -r build || mkdir build && cd build && cmake .. -DCMAKE_OSX_SYSROOT:PATH=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -DCMAKE_OSX_DEPLOYMENT_TARGET:STRING=10.9 -DCMAKE_BUILD_TYPE:STRING=Release -DCMAKE_INSTALL_PREFIX:PATH=/opt/local -DZLIB_LIBRARY_RELEASE:FILEPATH=/opt/local/lib/libz.dylib && make -j8 && sudo make install

cd ~/libexpat/expat && sudo rm -r build || mkdir build && cd build && DYLIB_CURRENT_VERSION=8.0.1 DYLIB_COMPATIBILITY_VERSION=7.0.0 cmake .. -DCMAKE_OSX_SYSROOT:PATH=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -DCMAKE_OSX_DEPLOYMENT_TARGET:STRING=10.9 -DCMAKE_BUILD_TYPE:STRING=Release -DCMAKE_INSTALL_PREFIX:PATH=/opt/local && make -j8 && sudo make install
...
cd ~/glib && git checkout 2.59.0 && LIBRARY_PATH='/opt/local/lib' LD=ld CC=clang CXX=clang++ CFLAGS="-O3 -mtune=generic -v -L/opt/local/lib -std=c11 -fstrict-aliasing -arch x86_64 -mmacosx-version-min=10.9 -I/opt/local/include" LDFLAGS="/opt/local/lib/libintl.8.dylib -v -bind_at_load -arch x86_64 -mmacosx-version-min=10.9 -L/opt/local/lib -Wl,-rpath -Wl,/opt/local/lib" CXXFLAGS="-O3 -mtune=generic -std=c++11 -I/opt/local/include -arch x86_64 -mmacosx-version-min=10.9" sh autogen.sh --prefix=/opt/local --with-sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk --with-harfbuzz=no --enable-shared=yes && LIBRARY_PATH='/opt/local/lib' LD=ld CC=clang CXX=clang++ CFLAGS="-O3 -mtune=generic -v L/opt/local/lib -std=c11 -fstrict-aliasing -arch x86_64 -mmacosx-version-min=10.9 -I/opt/local/include" LDFLAGS="/opt/local/lib/libintl.8.dylib -v -bind_at_load -arch x86_64 -mmacosx-version-min=10.9 -L /opt/local/lib -Wl,-rpath -Wl,/opt/local/lib" CXXFLAGS="-O3 -mtune=generic -std=c++11 -I/opt/local/include -arch x86_64 -mmacosx-version-min=10.9" make -j8 && sudo make install

cd ~/glib && sudo rm -r _build || git checkout master && LIBRARY_PATH='/opt/local/lib' LD=ld CC=clang CXX=clang++ CFLAGS="-std=c11 -O3 -mtune=generic -v -L/opt/local/lib -std=c11 -fstrict-aliasing -arch x86_64 -mmacosx-version-min=10.9 -I/opt/local/include" LDFLAGS="/opt/local/lib/libintl.8.dylib -v -bind_at_load -arch x86_64 -mmacosx-version-min=10.9 -L/opt/local/lib -Wl,-rpath -Wl,/opt/local/lib" CXXFLAGS="-O3 -mtune=generic -std=c++11 -I/opt/local/include -arch x86_64 -mmacosx-version-min=10.9" meson setup --pkg-config-path /opt/local/lib --cmake-prefix-path /opt/local/lib --prefix=/opt/local --buildtype=release _build . -D iconv=auto --cross-file ~/maccross --optimization 3 --default-library=both -D installed_tests=false -D dtrace=false -D bsymbolic_functions=false -D gio_module_dir=/opt/local/lib/gio/modules && LDFLAGS="-bind_at_load -arch x86_64 -mmacosx-version-min=10.9 -L/opt/local/lib" LIBRARY_PATH=/opt/local/lib LD=ld CC=clang CXX=clang++ CFLAGS="-std=c11 -O3 -mtune=generic -v -L/opt/local/lib -std=c11 -fstrict-aliasing -arch x86_64 -mmacosx-version-min=10.9 -I/opt/local/include" LDFLAGS="/opt/local/lib/libintl.8.dylib -v -arch x86_64 -mmacosx-version-min=10.9 -L/opt/local/lib  -Wl,-rpath -Wl,/opt/local/lib" CXXFLAGS="-O3 -mtune=generic -std=c++11 -I/opt/local/include -arch x86_64 -mmacosx-version-min=10.9" ninja -C _build && sudo ninja install -C _build && sudo install_name_tool -change libz.1.dylib /opt/local/lib/libz.1.dylib /opt/local/lib/libgio-2.0.0.dylib # also need a command to put the new version into the .la file

cd ~/lensfun && rm -r build || mkdir build && cd build &&  cmake ..  -DCMAKE_OSX_SYSROOT:PATH=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -DCMAKE_OSX_DEPLOYMENT_TARGET:STRING=10.9 -DCMAKE_BUILD_TYPE:STRING=Release -DCMAKE_INSTALL_PREFIX:PATH=/opt/local && make -j8 && sudo make install
...
cd ~/libsigcplusplus && git checkout 3.0.2 && LIBRARY_PATH="/opt/local/lib" LD=ld CC=clang CXX=clang++ CFLAGS="-arch x86_64 -mmacosx-version-min=10.9 -I/opt/local/include" LDFLAGS="-arch x86_64 -mmacosx-version-min=10.9 -L/opt/local/lib" CXXFLAGS="-arch x86_64 -mmacosx-version-min=10.9" sh autogen.sh --prefix=/opt/local --with-sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk --enable-shared=yes --disable-documentation && LIBRARY_PATH="/opt/local/lib" LD=ld CC=clang CXX=clang++ CFLAGS="-arch x86_64 -mmacosx-version-min=10.9 -I/opt/local/include" LDFLAGS="-arch x86_64 -mmacosx-version-min=10.9 -L/opt/local/lib" CXXFLAGS="-arch x86_64 -mmacosx-version-min=10.9" make -j8 && sudo make install
