...
cd ~/glib && git checkout 2.59.3 && meson -Dinstalled_tests=false --prefix=/opt/local -Dbsymbolic_functions=false -Diconv=gnu _build && ninja -j 8 -C _build && sudo ninja -C _build install
